...
const changePlanForm = (plan) => {
    ...
    const newContents = Object.assign(Object.assign({}, plan), { links: newLinks });
...
exports.changePlanForm = changePlanForm;
