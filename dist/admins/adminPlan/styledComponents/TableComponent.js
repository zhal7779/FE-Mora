...
exports.EnrollButton = exports.MainContentHeaderBlock = exports.PageNationBlockDiv = exports.PageNationBlock = exports.DetailBtn = exports.TableSearchResult = exports.TableTitle = exports.TableTitleBlock = exports.PlanInfo = exports.PlanListBlock = exports.TableRowInfo = exports.tableRowSetting = void 0;
const styled_components_1 = __importDefault(require("styled-components"));
const ModalComponents_1 = require("./ModalComponents");
// 테이블 요소들
exports.tableRowSetting = `
  display: grid;
...
`;
exports.PlanListBlock = styled_components_1.default.ul `
  margin-bottom: 20rem;
  min-height: 615px;
`;
exports.PlanInfo = styled_components_1.default.li `
  ${exports.tableRowSetting}
...
exports.PageNationBlock = styled_components_1.default.div `
  ...
  margin-bottom: 10rem;
`;
exports.PageNationBlockDiv = styled_components_1.default.div `
  width: 3rem;
  height: 3rem;
  padding-left: 0.1rem;
