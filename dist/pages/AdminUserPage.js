...
const AdminTable_1 = __importDefault(require("../admins/adminUser/components/AdminTable"));
...
const AdminUserPage = () => {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Header_1.default, {}), (0, jsx_runtime_1.jsxs)(AdminBlock_1.default, { children: [(0, jsx_runtime_1.jsx)(AdminSideBar_1.default, { nowCategoryName: sideBarCategory_1.USER_BUTTON }), (0, jsx_runtime_1.jsx)(AdminMainContainer_1.AdminMainContainer, { children: (0, jsx_runtime_1.jsx)(AdminTable_1.default, {}) })] })] }));
};
