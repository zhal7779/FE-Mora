  ...
  const myCoffeeChatData = [
    {
      ...
      content:
        '안녕하세요 저는 엘리스 SW 4기를 수료하고 프론트엔드 개발자를 목표로 하고 있는 엘리스라고 합니다. 제 포트폴리오와 자소서를 선배님께 보여드리고 조언을 얻고 싶어서 연락드리게 되었습니다! 이번주에 평일 저녁 이후 시간이 괜찮으시다면 직접 혹은 비대면으로 만나뵙고 싶습니다! 편하신 시간대에 아래 이메일이나 번호로 연락해주시면 너무 감사드릴 것 같습니다! 메일: elice77@gmail.com 번호: 010-1234-5678',
    },
    {
      accept: false,
